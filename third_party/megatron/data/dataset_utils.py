...
from third_party.megatron import (
    get_args,
    print_rank_0
)
from third_party.megatron.core import mpu
from third_party.megatron.data.blendable_dataset import BlendableDataset
from third_party.megatron.data.indexed_dataset import make_dataset as make_indexed_dataset
...
def _build_train_valid_test_datasets(data_prefix, data_impl, splits_string,
    ...
    def build_dataset(index, name):
        from third_party.megatron.data.bert_dataset import BertDataset
        from third_party.megatron.data.ict_dataset import ICTDataset
        from third_party.megatron.data.t5_dataset import T5Dataset
        dataset = None
...
def get_samples_mapping(indexed_dataset,
    ...
    if torch.distributed.get_rank() == 0 and \
       not os.path.isfile(indexmap_filename):
        ...
        from third_party.megatron.data import helpers
