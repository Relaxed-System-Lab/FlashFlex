...
from third_party.megatron.data.dataset_utils import create_masked_lm_predictions, pad_and_convert_to_numpy
from third_party.megatron import get_args, get_tokenizer, print_rank_0
...
def get_one_epoch_dataloader(dataset, micro_batch_size=None):
    ...
    from third_party.megatron.data.samplers import DistributedBatchSampler
