...
from third_party.megatron.text_generation import generate_and_post_process
from third_party.megatron.text_generation import beam_search_and_post_process
