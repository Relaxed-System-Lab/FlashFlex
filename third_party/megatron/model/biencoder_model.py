...
from third_party.megatron import get_args, print_rank_0, get_tokenizer
from third_party.megatron.core import mpu
from third_party.megatron.checkpointing import fix_query_key_value_ordering
from third_party.megatron.checkpointing import get_checkpoint_tracker_filename
from third_party.megatron.checkpointing import get_checkpoint_name
from third_party.megatron.model.bert_model import bert_position_ids
from third_party.megatron.model.enums import AttnMaskType
from third_party.megatron.model.language_model import get_language_model
from third_party.megatron.model.utils import get_linear_layer
from third_party.megatron.model.utils import init_method_normal
from third_party.megatron.model.utils import scaled_init_method_normal
...
class BiEncoderModel(MegatronModule):
    ...
    def init_state_dict_from_bert(self):
        ...
        try:
            ...
            from third_party.megatron.fp16_deprecated import loss_scaler
